...
export default function AdminHome() {
  ...
  useEffect(() => {
    fetch('/api/admin_user', { credentials: 'include' })
  ...
  return (
    <div>
      <h1>Admin Panel</h1>
      <a href="/admin/login" onClick={async e => {e.preventDefault(); await fetch('/api/admin_logout', {credentials:'include'}); window.location.reload()}}>Logout</a>
      <h2>Plans</h2>
      <table>
